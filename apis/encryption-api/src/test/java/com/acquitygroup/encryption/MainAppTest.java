...
public class MainAppTest {
    ...
    // @Test
    // public void encrypt() {
    // MainApp.main(createArguments("encrypt",
    // "'this is the message that should be decrypted'", initialIV));
    // }
    //
    // @Test
    // public void decrypt() {
    // MainApp.main(createArguments("decrypt",
    // "kFKgXtUKBWdZLgaSyx+RhS/ZbpiXxZqiHTcdRCruJu74fpZnapVbvugka/o9+2IE",
    // initialIV));
    // }
    //
    // @Test
