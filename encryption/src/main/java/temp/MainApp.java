...
public class MainApp {
    ...
    //
    // checkArgument(!isNullOrEmpty(keystoreFileLocation),
    // "Please provide a 'keystore' file location.");
    // checkArgument(!isNullOrEmpty(storePass),
    // "Please provide a 'storepass' password for keystore");
    // checkArgument(!isNullOrEmpty(alias),
    // "Please provide an 'alias' for the specific key");
    // checkArgument(!isNullOrEmpty(keyPass),
    // "Please provide a 'keypass' for the specific key");
    //
    //
    // LOG.debug("Keystore: {}\nStorePass: {}\nAlias: {}\nKeyPass: {}\n",
    // keystoreFileLocation, storePass, alias, keyPass);
    //
    // Key keyFromKeyStore = KeystoreUtil.getKeyFromKeyStore(keystoreFileLocation,
    ...
    // "Command encryption takes 2 arguments: Message to encrypt and IV in String format");
    ...
    // case "decrypt":
    // checkArgument(args.length==3,
    // "Command decryption takes 2 arguments: Message to encrypt and IV in String format");
