...
public class AESCipherTest {
    ...
    // LoggerFactory.getLogger(AESCipherTest.class);
    //
    // @Rule
    ...
    //
    // LOG.debug("Original Message: {}, Encrypted Message: {}, Decrypted Message: {}",
    // messageToEncrypt, encryptedMessage, decryptedMessage);
    ...
    //
    // Key key =
    // KeystoreUtil.getKeyFromKeyStore("src/test/resources/aes-keystore.jck",
    // "mystorepass", "jceksaes", "mykeypass");
    //
    ...
    //
    // @Test
    // public void usingStringBasedIVWithUTF8ExtendedCharacter() throws
    ...
    //
    // @Test
    // public void usingStringBasedIVWithIncorrectLength() throws
    // UnsupportedEncodingException {
    //
    // thrown.expectCause(isA(InvalidAlgorithmParameterException.class));
    // thrown.expectMessage("Wrong IV length: must be 16 bytes long");
    ...
    // differentCipher.getDecryptedMessage(encryptedMessage);
    //
    // LOG.debug("Original Message: {}, Encrypted Message: {}, Decrypted Message: {}",
    // messageToEncrypt, encryptedMessage, decryptedMessage);
    // assertThat(decryptedMessage, is(messageToEncrypt));
    ...
    // differentCipher.getDecryptedMessage(encryptedMessage);
    //
    // LOG.debug("Encrypted: [{}], Decrypted[{}]", encryptedMessage,
    // decryptedMessage);
    //
